...
import { imgDatabase, titleDatabase } from "../../data/quinoa/quinoa_content";
...
export default function RecipesDetail({
  ...
  return (<StyledRecipesDetail>
      ...
      <StySteps>
        ...
        text={recipeDatabase[1][0]}
        img=""
        />

        <StepsBox
        number={numDatabase[1]} 
        text={recipeDatabase[1][1]}
        img=""
        />

        <StepsBox
        number={numDatabase[2]} 
        text={recipeDatabase[1][2]}
        img=""
        />

        <StepsBox 
        number={numDatabase[3]} 
        text={recipeDatabase[1][3]}
        img=""
        />

        <StepsBox
        number={numDatabase[4]} 
        text={recipeDatabase[1][4]}
        img={imgDatabase[1]}
        />
      </StySteps>
